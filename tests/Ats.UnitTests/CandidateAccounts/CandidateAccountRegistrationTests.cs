...
public class CandidateAccountRegistrationTests
{
    ...
    {
        var account = CandidateAccount.Register("Jane@Example.COM", PasswordHash, "Jane", "Doe", SupportedLanguages.Default);
    ...
    public void Register_should_reject_a_missing_email(string? email)
    {
        Assert.Throws<ArgumentException>(
            () => CandidateAccount.Register(email!, PasswordHash, "Jane", "Doe", SupportedLanguages.Default));
    }
    ...
    {
        Assert.Throws<ArgumentException>(
            () => CandidateAccount.Register("jane@example.com", PasswordHash, firstName!, "Doe", SupportedLanguages.Default));
    }
    ...
    {
        Assert.Throws<ArgumentException>(
            () => CandidateAccount.Register("jane@example.com", PasswordHash, "Jane", lastName!, SupportedLanguages.Default));
    }
