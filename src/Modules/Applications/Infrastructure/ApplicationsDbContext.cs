...
public sealed class ApplicationsDbContext : DbContext, IApplicationsDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        // Register the tenant + soft-delete filter via an instance method so EF treats
        // _currentTenant as a context accessor (re-evaluated per query) rather than baking the
        // first scope's value into the cached model. Identical to JobsDbContext.
